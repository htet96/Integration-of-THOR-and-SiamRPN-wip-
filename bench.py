...
from trackers.tracker import SiamFC_Tracker, SiamRPN_Tracker, SiamMask_Tracker, SiamRPNpp_Tracker
...
parser.add_argument('-t', '--tracker', dest='tracker', required=True,
                    help='Name of the tracker [SiamFC, SiamRPN, SiamMask, SiamRPNpp]')
...
def run_bench(delete_after=False):
    ...
    elif args.tracker == 'SiamRPNpp':
        tracker = SiamRPNpp_Tracker(cfg)
    else:

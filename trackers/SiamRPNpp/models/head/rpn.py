...
from trackers.SiamRPNpp.core.xcorr import xcorr_fast, xcorr_depthwise
from trackers.SiamRPNpp.models.init_weight import init_weights
...
class UPChannelRPN(RPN):
    def __init__(self, anchor_num=5, in_channels=256,out_channels=0): #out_channels没有用到
